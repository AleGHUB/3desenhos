...
Os scripts ficam em `.claude/skills/product-ad-cinema/scripts/` (caminho relativo à raiz do repo). Se a skill estiver instalada globalmente, use `~/.claude/skills/product-ad-cinema/scripts/`.
